        ...
        <div class="col s12 m8 l4 offset-m2 offset-l4">
            ...
            <div class="card-content">
                ...
                <div class="form-field">
                    ...
                    <select name='country' class="browser-default" require>
                ...
                <div class="form-field">
                    ...
                    <select name='state' class="browser-default" require>
                ...
                <div class="form-field">
                    ...
                    <select name='city' class="browser-default" require>
                ...
                <div class="form-field">
                    <div class="file-field input-field">
                        <label for="latitude">Property latitude </label>
                ...
                <div class="form-field">
                    <div class="file-field input-field">
                        <label for="longitude">Property longitude </label>
            ...
            <div class="form-field">
                <button class="btn-large deep-purple waves-effect waves-dark" style="width:100%;">Add land</button>
            </div><br>
